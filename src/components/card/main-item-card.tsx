...
export default function MainItemCard({postedId}: {postedId: string}) {

    return(
        <Link href={`posted/${postedId}`} className="w-62 flex flex-col items-center ">
            ...
            <div className="w-full">
                <h4 className="my-(--header-margin-4)">Title Container~!</h4>
